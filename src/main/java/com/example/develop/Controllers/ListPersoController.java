...
import com.example.develop.model.Issue;
import com.example.develop.model.ResultIssue;
...
public class ListPersoController implements Initializable {
	...
	void handleClickListView(MouseEvent event) throws IOException {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../../../../resources/com/example/develop/ComicView.fxml"));
	...
	void returnHandler(MouseEvent event) throws IOException {
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("../../../../../resources/com/example/develop/Views/MainPage.fxml"));
